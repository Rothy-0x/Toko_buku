...
def cdangka():
    print("\nData Angka:", dataAngka)
    print("Panjang Data Angka Sekarang:", len(dataAngka))

#function untuk menambahkan data
def tdangka():
    dataAngka.append(int(input("Masukkan Angka yang ingin ditambahkan: ")))
    clear()
...
def hdangka():
    dataAngka.pop(int(input("Masukkan index Angka ke berapa yang ingin dihapus: ")))
    clear()
